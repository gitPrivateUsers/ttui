...
import org.pussinboots.morning.administrator.mapper.AddressMapper;
...
public class AddressServiceImpl extends ServiceImpl<AddressMapper, Address> implements IAddressService {
     ...
     */
	@Override
	public AddressPageDTO listByPage(PageInfo pageInfo, String search) {
		Page<Address> page = new Page<>(pageInfo.getCurrent(),pageInfo.getLimit());
		List<Address> addressVOs = addressMapper.listByPage(pageInfo,search,page);
		pageInfo.setTotal(page.getTotal());
		return new AddressPageDTO(addressVOs,pageInfo);
	}

	@Override
	public Integer updateAddressId(Long addressId, Address address) {
		address.setUpdateTime(new Date());
		return addressMapper.updateById(address);
	}

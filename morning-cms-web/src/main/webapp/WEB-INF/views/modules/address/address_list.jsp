                ...
                <div class="example">
                  <div id="toolbar" class="btn-group m-t-sm">
                    <shiro:hasPermission name="customer:detail:create">
                      <button type="button" class="btn btn-default" title="添加用户地址"  onclick="layer_show('添加用户地址','${ctx}/customer/detail/create','800','700')"> <i class="glyphicon glyphicon-plus"></i> </button>
                    </shiro:hasPermission>
                  </div>
                  <table id="table"
                         data-toggle="table"
                         ...
                         data-url="${ctx}/address/list/info"
...
<myfooter>
  ...
  <!-- 自定义js -->
  <script src="${ctxsta}/cms/js/addressList.js"></script>
</myfooter>
</body>
</html>
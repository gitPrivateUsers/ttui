                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="radio-inline">
                                    <input type="checkbox" class="js-switch" name="status" value="1" ${product.showInTop eq '1'?'checked="checked"':''}/>
                                    是否置顶</label>
                                <label class="radio-inline">
                                    <input type="checkbox" class="js-switch" name="showInNav" value="1" ${product.showInNav eq '1'?'checked="checked"':''}/>
                                    是否导航</label>
                                <label class="radio-inline">
                                    <input type="checkbox" class="js-switch" name="showInTop" value="1" ${product.showInHot eq '1'?'checked="checked"':''} />
                                    是否热门</label>
                                <label class="radio-inline">
                                    <input type="checkbox" class="js-switch" name="showInHot" value="1" ${product.showInShelve eq '1'?'checked="checked"':''} />
                                    是否上架</label>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>

...
public class wxService extends BaseController {
    ...
    @ResponseBody
    public OsResult delete(Model model, @RequestParam("productSpecNumber") Long productSpecNumber) {
    ...
    @ResponseBody
    public OsResult updateStatus(Model model, @RequestParam("productSpecNumber") Long productSpecNumber,
